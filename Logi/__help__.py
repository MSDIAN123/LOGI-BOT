import importlib, re
from Logi import dispatcher, ALLOW_EXCL, LOGGER
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, ParseMode, Update
from Logi.Handlers.misc import paginate_modules
