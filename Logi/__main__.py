...
def Logi_about_callback(update: Update, context: CallbackContext):
    first_name = update.effective_user.first_name
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(Logi_about_callback, pattern=r"Logi_", run_async=True)
