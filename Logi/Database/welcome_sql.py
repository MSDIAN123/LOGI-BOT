...
from Logi.Handlers.msg_types import Types
from Logi.Database import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} just joined. EverLogi, look busy!",
    ...
    "EverLogi stop what you’re doing, We are now in the presence of {first}.",
