...
import Logi
import Logi.Database.welcome_sql as sql
import Logi.Database.global_bans_sql as gban_sql
from Logi import (
    REQUESTER, DEV_USERS, INSPECTOR, JOIN_LOGGER, LOGGER,
    OWNER_ID, dispatcher
)
from Logi.Handlers.validation import (
    is_user_ban_protected, user_admin, connection_status,
)
from Logi.Handlers.misc import (
    build_keyboard,
    revert_buttons,
)
from Logi.Handlers.msg_types import get_welcome_type
...
def welcome(update: Update, context: CallbackContext):
    ...
    if not args or args[0].lower() == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text(
                "I'll go loaf around and not welcome anLogi then.",
            )
