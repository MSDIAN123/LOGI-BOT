...
import Logi.Database.connection_sql as sql
from Logi import dispatcher, INSPECTOR, DEV_USERS
from Logi.Handlers import validation
...
__help__ = """
Sometimes, you just want to add some notes and filters to a group chat, but you don't want everLogi to see; This is where connections come in...
