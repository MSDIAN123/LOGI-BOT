...
from Logi.__help__ import STATS, USER_INFO
import Logi.Database.userinfo_sql as sql
from Logi.Plugins.disable import DisableAbleCommandHandler
from Logi.Database.global_bans_sql import is_user_gbanned
from Logi.Database.afk_sql import is_afk, check_afk_status
from Logi.Database.users_sql import get_user_num_chats
from Logi.Handlers.validation import sudo_plus, user_admin, support_plus
from Logi.Handlers.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n┣|• This user is member of 'Logi Developer Team'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/Logi_channel">?</a>]'.format(
            bot.username
        )
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/Logi_channel)
"""
__mod_name__ = "Infos"
